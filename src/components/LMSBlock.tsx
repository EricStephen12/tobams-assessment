...
const LMSBlock = () => {
  ...
  return (
    <section>
     ...
     <div className="w-full space-y-20 py-20 bg-white">
      {/* Corporate Trainings Section */}
      <div className="max-w-[1800px] mx-auto px-10 flex items-center gap-20">
        {/* Left: Content */}
        <div className="flex-1 space-y-8">
          <h2 className="text-5xl font-medium text-black">Corporate Trainings</h2>
          ...
          <ul className="space-y-4 px-8">
            {corporatePoints.map((point) => (
              <li key={point} className="flex items-center gap-3 text-gray-500 font-medium text-lg">
                <FaBolt className="text-brand-primary" size={18} />
                {point}
              </li>
            ))}
          </ul>
        ...
        <div className="flex-shrink-0">
          <div className="relative w-[750px] h-[480px]">
            <Image
              src={corporateImg}
      ...
      <div className="max-w-[1800px] mx-auto px-10 flex items-center gap-20">
        ...
        {/* Right: Content */}
        <div className="flex-1 space-y-8">
          <h2 className="text-5xl font-medium text-black">Personalised Individual Training</h2>
          <p className="text-lg text-gray-500 leading-relaxed max-w-2xl">
      ...
      <div className="max-w-[1800px] mx-auto px-10 flex items-center gap-20">
        {/* Left: Content */}
        <div className="flex-1 space-y-8">
          <h2 className="text-5xl font-medium text-black">Capacity Development</h2>
          <p className="text-lg text-gray-500 leading-relaxed max-w-2xl">
