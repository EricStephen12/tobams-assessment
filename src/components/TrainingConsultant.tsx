...
const TrainingConsultant = () => {
  ...
  return (
    ...
    <section className="py-20 px-4 bg-bg-pale">
      <div className="max-w-[1800px] mx-auto px-10 space-y-12">
        
        <div className="space-y-6 max-w-7xl">
          <h2 className="text-5xl font-[500] text-brand-primary">
            Training The Consultant
          </h2>
          <h3 className="text-brand-primary font-medium text-xl">
        ...
        <div className="bg-brand-primary rounded-[5px] p-5 text-white">
