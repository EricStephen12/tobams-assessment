  ...
  return (
    <section className="mt-15">
      <div className="bg-bg-pale py-16 px-4 overflow-hidden">
        <div className="max-w-[1800px] mx-auto flex items-center gap-12 px-4">
          ...
          <div className="flex-1 space-y-8 py-6">
            <h2 className="text-5xl font-[500] text-brand-primary">
              Learning Management System
            </h2>

            <div className="bg-bg-palepink backdrop-blur-sm p-12 rounded-3xl border border-white/20 space-y-6 min-h-[400px] flex flex-col justify-center">
            ...
            <CTA text="Learn More" showArrow={true} className="pt-4" />
          </div>
        </div>
      </div>
    </section>
